      ...
      <div className="bg-white border border-kiosk-orange-100 rounded-[1.618rem] overflow-hidden">
        <table className="w-full text-sm">
          <thead className="bg-kiosk-bg border-b border-kiosk-orange-100">
            <tr>
              <th className="text-left px-5 py-3 text-xs font-semibold text-kiosk-ink-muted uppercase tracking-wider">Judul</th>
              <th className="text-left px-5 py-3 text-xs font-semibold text-kiosk-ink-muted uppercase tracking-wider">Kategori</th>
              <th className="text-left px-5 py-3 text-xs font-semibold text-kiosk-ink-muted uppercase tracking-wider">Status</th>
              <th className="text-left px-5 py-3 text-xs font-semibold text-kiosk-ink-muted uppercase tracking-wider">Tanggal</th>
          ...
          <tbody className="divide-y divide-kiosk-orange-100">
            {filtered.map((a: any) => (
              <tr key={a.id} className="hover:bg-kiosk-bg">
                ...
                <td className="px-5 py-4">
                  <span className={`text-xs font-medium px-2.5 py-1 rounded-[0.618rem] border ${statusBadge[a.status] || statusBadge.draft}`}>
                    {a.status}
                  </span>
                </td>

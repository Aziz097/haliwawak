    ...
    <footer className="bg-kiosk-ink px-4 py-16 text-white/70">
      <div className="page-container">
        <div className="mb-12 grid grid-cols-1 gap-12 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="max-w-sm text-sm leading-relaxed">
              Sistem Informasi Eduwisata Polinator Situs Purbakala Pugung Raharjo, Lampung Timur,
              Lampung.
            </p>
          </div>
          <div>
            <p className="mb-4 font-heading text-sm font-bold uppercase tracking-wider text-white">
              Navigasi
            </p>
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 text-sm md:flex-row">
          ...
          <p>
            Didukung oleh{' '}
            <span className="font-medium text-white">Institut Teknologi Sumatera</span> &
            Kemdiktisaintek RI
          </p>
        </div>
      </div>

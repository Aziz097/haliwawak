...
export default function EmptyState({ caption = EMPTY_STATE }: EmptyStateProps) {
  ...
  return (
    <div
      role="status"
      className="flex flex-col items-center justify-center gap-4 rounded-2xl border border-kiosk-orange-200 bg-kiosk-surface-tint px-8 py-12 text-center"
    >
      <span className="flex h-16 w-16 items-center justify-center rounded-full bg-kiosk-orange-100 text-kiosk-orange-600">

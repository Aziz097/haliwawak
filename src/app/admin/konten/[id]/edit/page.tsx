...
const INPUT_CLS = 'bg-kiosk-bg px-4 py-2.5 border border-kiosk-orange-100 rounded-[1rem] text-sm text-kiosk-ink focus:outline-none focus:border-kiosk-orange-600 focus:ring-1 focus:ring-kiosk-orange-600 transition-all placeholder:text-kiosk-ink-muted';
...
const SECTION_TITLE_CLS = 'text-xs font-bold text-kiosk-orange-600 uppercase tracking-wider border-b border-kiosk-orange-100 pb-3 mb-5';
...
export default function EditArticlePage() {
  ...
  if (loading) return <div className="min-h-screen bg-kiosk-bg flex items-center justify-center"><p className="text-kiosk-ink-muted">Memuat...</p></div>;
  if (!form) return <div className="min-h-screen bg-kiosk-bg flex items-center justify-center"><p className="text-danger">Data tidak ditemukan</p></div>;

  return (
    <div className="min-h-screen bg-kiosk-bg">
      <div className="max-w-3xl mx-auto px-4 py-8">
        <Link href="/admin/konten" className="inline-flex items-center gap-2 text-kiosk-ink-muted hover:text-kiosk-ink mb-6 text-sm transition-colors">
          ...
          <section className={SECTION_CLS}>
            ...
            {form.thumbnailUrl ? (
              <div className="relative group rounded-[1.618rem] overflow-hidden">
                <img src={form.thumbnailUrl} alt="Thumbnail" className="w-full h-48 object-cover rounded-[1.618rem]" />
              ...
              >
                ...
                <span className="text-sm text-kiosk-ink-muted">Drag & drop atau klik untuk upload</span>

...
export default function NewArticlePage() {
  ...
  const [form, setForm] = useState({
    title: '', slug: '', category: 'Edukasi', content: '', summary: '', status: 'draft', thumbnailUrl: '',
  });
  ...
  return (
    <div className="min-h-screen bg-kiosk-bg">
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <h1 className="font-heading text-2xl font-bold text-kiosk-ink mb-8">Tambah Artikel Baru</h1>

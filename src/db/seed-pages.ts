...
<section style="padding:4rem 1rem;">
  <div style="max-width:1100px; margin:0 auto; display:grid; grid-template-columns:repeat(3,1fr); gap:2rem; text-align:center;">
    <div style="background:white; border:1px solid #e5e7eb; border-radius:1rem; padding:2rem;">
      <p style="font-size:2.5rem; font-weight:bold; color:#2B7A4B;">47+</p>
      <p style="color:#6b7280;">Spesies Terdokumentasi</p>
    </div>
    <div style="background:white; border:1px solid #e5e7eb; border-radius:1rem; padding:2rem;">
      <p style="font-size:2.5rem; font-weight:bold; color:#2B7A4B;">33 Ha</p>
      <p style="color:#6b7280;">Luas Kawasan</p>
    </div>
    <div style="background:white; border:1px solid #e5e7eb; border-radius:1rem; padding:2rem;">
      <p style="font-size:2.5rem; font-weight:bold; color:#2B7A4B;">Sejak 1967</p>
...
<section style="padding:4rem 1rem; background:rgba(42,122,75,0.08); border-top:1px solid #e5e7eb;">
  <div style="max-width:720px; margin:0 auto;">
...
<section style="padding:4rem 1rem;">
  <div style="max-width:1100px; margin:0 auto; display:grid; grid-template-columns:repeat(2,1fr); gap:2rem;">
    ...
    <div style="background:white; border:1px solid #e5e7eb; border-radius:1rem; padding:2rem;">
      ...
      <p style="font-weight:600;">Rp 5.000 / orang</p>
    </div>
  </div>
</section>
  ...
  <div style="max-width:720px; margin:0 auto;">
    ...
    <ol style="list-style:none; padding:0; color:#6b7280;">
      <li style="margin-bottom:1rem; display:flex; gap:0.75rem;">
        <span style="width:1.5rem; height:1.5rem; border-radius:50%; background:#2B7A4B; color:white; font-size:0.75rem; font-weight:bold; display:flex; align-items:center; justify-content:center; flex-shrink:0;">1</span>
      ...
      <li style="margin-bottom:1rem; display:flex; gap:0.75rem;">
        <span style="width:1.5rem; height:1.5rem; border-radius:50%; background:#2B7A4B; color:white; font-size:0.75rem; font-weight:bold; display:flex; align-items:center; justify-content:center; flex-shrink:0;">2</span>
      ...
      <li style="margin-bottom:1rem; display:flex; gap:0.75rem;">
        <span style="width:1.5rem; height:1.5rem; border-radius:50%; background:#2B7A4B; color:white; font-size:0.75rem; font-weight:bold; display:flex; align-items:center; justify-content:center; flex-shrink:0;">3</span>
      ...
      <li style="margin-bottom:1rem; display:flex; gap:0.75rem;">
        <span style="width:1.5rem; height:1.5rem; border-radius:50%; background:#2B7A4B; color:white; font-size:0.75rem; font-weight:bold; display:flex; align-items:center; justify-content:center; flex-shrink:0;">4</span>
      ...
      <li style="margin-bottom:1rem; display:flex; gap:0.75rem;">
        <span style="width:1.5rem; height:1.5rem; border-radius:50%; background:#2B7A4B; color:white; font-size:0.75rem; font-weight:bold; display:flex; align-items:center; justify-content:center; flex-shrink:0;">5</span>
  ...
  <div style="max-width:720px; margin:0 auto; text-align:center;">
    ...
    <ul style="list-style:none; padding:0; color:#6b7280; text-align:left;">
      <li style="margin-bottom:0.75rem; padding-left:1.5rem; position:relative;">
        <span style="position:absolute; left:0; color:#2B7A4B;">&bull;</span>
...
export async function seedPages() {
  for (const page of PAGES) {
    ...
    if (existing.length === 0) {
      ...
      console.log(`Page already exists: ${page.slug}, skipping`);
    }
  }
